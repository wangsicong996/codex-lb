...
- [x] 1. Add stale keep-alive reconnect + ServerDisconnected pre-dispatch classification
- [x] 2. Add DELETE endpoint/pool settings API with binding guard and route-cache invalidation
